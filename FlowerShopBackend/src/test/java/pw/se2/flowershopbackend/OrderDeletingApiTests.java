...
public class OrderDeletingApiTests {
    @TestConfiguration
    static class OrderDeletingApiTestsContextConfiguration {
        @Autowired
    ...
    @Test
    public void tryDeletingOrderAsEmployee() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                employee, null, employee.getAuthorities()
        ));
        mvc.perform(delete("/api/orders/"+order.getId().toString()))
                .andExpect(status().is2xxSuccessful());
    }
    @Test
    public void tryDeletingOrderAsDeliveryMan() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
    ...
    @Test
    public void tryDeletingOrderAsClient() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
    ...
    @Test
    public void tryDeletingAcceptedOrderAsClient() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                user, null, user.getAuthorities()
        ));
    ...
    @Test
    public void tryDeletingAcceptedOrderAsEmployee() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                employee, null, employee.getAuthorities()
        ));
        order.setStatus(Order.Status.Accepted);
    ...
    @Test
    public void tryDeletingDeliveredOrderAsClient() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                user, null, user.getAuthorities()
        ));
    ...
    @Test
    public void tryDeletingDeliveredOrderAsEmployee() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                employee, null, employee.getAuthorities()
        ));
        order.setStatus(Order.Status.Delivered);
