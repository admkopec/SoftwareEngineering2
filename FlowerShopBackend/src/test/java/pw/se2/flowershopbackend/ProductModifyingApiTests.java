...
public class ProductModifyingApiTests {
    @TestConfiguration
    static class ProductModifyingApiTestsContextConfiguration {
        @Autowired
    ...
    @Test
    public void givenInvalidCredentials_whileModifyingProduct_thenReturnError() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
                user, null, user.getAuthorities()
        ));
        mvc.perform(put("/api/products/A9007774-CA6F-4D99-9E58-A3913988F1DD").contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void givenValidCredentials_whileModifyingProduct_thenReturnError() throws Exception {
        SecurityContextHolder.getContext().setAuthentication(new UsernamePasswordAuthenticationToken(
